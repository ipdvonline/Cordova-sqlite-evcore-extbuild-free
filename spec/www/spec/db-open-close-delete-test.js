    ...
    for (var i=0; i<pluginScenarioCount; ++i) {
      ...
      describe(pluginScenarioList[i] + ': open database file name test(s)', function() {
        ...
        it(suiteName + 'Open database with U+0801 (3-byte Samaritan character Bit) & check internal database file name', function(done) {
          // XXX KNOWN CRASH on Android (default evcore-native-driver database access implementation)
          // ref: litehelpers/Cordova-sqlite-evcore-extbuild-free#26
          if (!isWindows && isAndroid && !isImpl2) pending('XXX KNOWN CRASH on Android (default evcore-native-driver database access implementation)');
